        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Add SubCategory <small>different form elements</small></h2>
                ...
                <div class="x_content">
                  <br />
                    ...
                    <?php echo form_open('Admin/insert_subcategory','class="form-horizontal form-label-left" id="demo-form2"'); ?>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="subcategory" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
