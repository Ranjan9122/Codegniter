        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Edit Banner <small>different form elements</small></h2>
                ...
                <div class="x_content">
                  <br />
                    ...
                    <?php echo form_open_multipart('Admin/update_banner','class="form-horizontal form-label-left" id="demo-form2"'); ?>

                   <input type="hidden" name="id" value="<?php echo $this->input->get('id'); ?>"> 

                    <?php 
                      foreach ($editbanner as $result )
                      {
                      ?>

                    <div class="form-group">  
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <img src="<?php echo base_url('uploads/banner/'. $result->image); ?>" style="height:200px; width:200px; margin-left:400px ">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="name" id="first-name" required="required" value="<?php echo $result->name; ?>" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="file" name="image" id="first-name"  class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
