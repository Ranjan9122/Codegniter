              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                    ...
                    <?php echo form_open('Admin/update_subcategory','class="form-horizontal form-label-left" id="demo-form2"'); ?>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="category" id="first-name" required="required" value="<?php echo $this->input->get('category'); ?>" class="form-control col-md-7 col-xs-12" readonly="">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="subcategory" id="first-name" required="required" value="<?php echo $this->input->get('subcategory'); ?>" class="form-control col-md-7 col-xs-12">
                      </div>
                    </div>
