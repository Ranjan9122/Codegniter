        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Add Banner <small>different form elements</small></h2>
                ...
                <div class="x_content">
                  <br />
                    ...
                    <?php echo form_open_multipart('Admin/insert_banner','class="form-horizontal form-label-left" id="demo-form2"'); ?>
