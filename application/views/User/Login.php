...
<!-- login -->
	<div class="login">
		<div class="container">
                              ...
                              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                ...
                                <p><strong>Error! &nbsp;&nbsp;</strong>'.$this->session->flashdata('message').'</p></div>'; ?>
                                    <?php endif; ?>
                                     ...
                                     <?php if($this->session->flashdata('notregister')): ?>
                             <?php echo '<div class="alert alert-danger icons-alert">
                              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                  <i class="icofont icofont-close-line-circled"></i>
                                  </button>
                                <p><strong>Error! &nbsp;&nbsp;</strong>'.$this->session->flashdata('notregister').'</p></div>'; ?>
                                    <?php endif; ?>
			...
			<p><a href="<?php echo base_url('User/register'); ?>">Register Here</a> (Or) go back to <a href="<?php echo base_url(); ?>">Home<span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span></a></p>
		</div>
	</div>
<!-- //login -->
<!-- //footer -->
