	...
	<div class="login">
		<div class="container">
			...
			<div class="login-form-grids animated wow slideInUp" data-wow-delay=".5s">
				...
				<?php echo form_open_multipart('User/update_profile_details'); ?>
				<?php 
                      foreach ($viewuser as $result )
                      {
                      	 $image= $result->image; 
                      ?>
				<?php 
				...
				<center><img src="<?php echo base_url('uploads/user/download.jpeg'); ?>" style="height: 100px;width: 100px; " /></center>
				<?php }else{
					 ?>
					<center> <img src="<?php echo base_url('uploads/user/'. $result->image); ?>" style="height: 100px;width: 100px;" /></center>
					 <?php } ?>

					<input type="file" name="image" >
					<input type="text" name="fname" value="<?php echo $result->fname; ?>" placeholder="First Name" required=" " >

					<input type="hidden" name="email" value="<?php echo $result->email; ?>" placeholder="First Name" required=" " >

					<input type="text" name="lname" value="<?php echo $result->lname; ?>" placeholder="Last Name" required=" " >
					<input type="text" name="mobile" value="<?php echo $result->mobile; ?>" placeholder="Mobile No.">
